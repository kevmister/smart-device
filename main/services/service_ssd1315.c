...
void ssd1315_draw_bmp (uint8_t x0, uint8_t y0, uint8_t x1, uint8_t y1,
                       uint8_t bitmap[]) {
  uint16_t j = 0;
  uint8_t y, x;
  if (y1 % 8 == 0)
...
service_start_error_t service_ssd1315_start () {
  xTaskCreate (&service_ssd1315_task, "service_ssd1315_task", 8192, NULL, 5,
  NULL);
...
service_t service_ssd1315 = { .name = "SSD1315", .initialized = 0, .configured =
    0, .started = 0, .init_handler = service_ssd1315_init, .config_handler =
    service_ssd1315_config, .start_handler = service_ssd1315_start,
    .stop_handler = service_ssd1315_stop, .end_handler = service_ssd1315_end,
